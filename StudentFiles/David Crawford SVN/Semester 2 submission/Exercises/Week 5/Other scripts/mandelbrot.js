...
return Vector2(c.x*c.x - c.y*c.y, c.x*c.y*2);
}
...
function Mandelbrot(point:Vector2):Color {
	...
	return Color.Lerp(Color.blue,Color.red, i * 1.0 /iterations);
}
}
...
function Update () {
	...
	point.x = (currentX * 1.0 / texture.width -0.5) * 3.0;
	point.y = (currentY * 1.0/ texture.height - 0.5) * 3.0;
